...
const requests = {
    ...
    Outbound: {
        ...
        UpdateFulfillmentOrder: {
            params: {
                SellerFulfillmentOrderId: { name: 'SellerFulfillmentOrderId', required: true },
                ShippingSpeedCategory: { name: 'ShippingSpeedCategory', required: false, type: 'fba.ShippingSpeedCategory' },
                DisplayableOrderId: { name: 'DisplayableOrderId', required: false },
                DisplayableOrderDateTime: { name: 'DisplayableOrderDateTime', type: 'Date' },
                DisplayableOrderComment: { name: 'DisplayableOrderComment' },
                FulfillmentPolicy: { name: 'FulfillmentPolicy', required: false, type: 'fba.FulfillmentPolicy' },
