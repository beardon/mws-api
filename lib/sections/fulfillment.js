    ...
    Inbound: {
        ...
        CreateInboundShipment: {
            params: {
                ...
                InboundShipmentItems: { type: Type.COMPLEX, required: true, construct: complex.InboundShipmentItems }
            }
        },
        ...
        CreateInboundShipmentPlan: {
            parms: {
                ...
                InboundShipmentPlanRequestItems: { type: Type.COMPLEX, required: true, construct: complex.InboundShipmentPlanRequestItems }
            }
        },
    ...
    Outbound: {
        ...
        CreateFulfillmentOrder: {
            params: {
                ...
                LineItems: { type: Type.COMPLEX, required: true, construct: complex.CreateLineItems }
            }
        },
        ...
        GetFulfillmentPreview: {
            params: {
                ...
                LineItems: { type: Type.COMPLEX, required: true, construct: complex.PreviewLineItems },
        ...
        ListAllFulfillmentOrders: {
            params: {
                QueryStartDateTime: { required: true, type: Type.TIMESTAMP },
        ...
        UpdateFulfillmentOrder: {
            params: {
                ...
                DestDistrictOrCounty: { name: 'DestinationAddress.DistrictOrCounty' },
                DestPhoneNumber: { name: 'DestinationAddress.PhoneNumber' },
                LineItems: { type: Type.COMPLEX, required: false, construct: complex.CreateLineItems }
            }
        }
    }
};
